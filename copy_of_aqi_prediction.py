...
forcast_period = st.sidebar.number_input("Forcast Period Days",min_value=1,max_value=1000,step=1)
...
if st.sidebar.button("GO"):
    ...
    st.write("Forcast ",str(forcast_period)," days into the future")
...
#   """**Predicting for the next 1 year, 3 years and 5 years respectively**"""
    ...
    prd = int(forcast_period) #int(input("Enter time period for forecast- 182 days, 365 days, or 547 days : "))
    ...
    # Display plot in Streamlit
    st.pyplot(plt.gcf())
    specific_date = str("2020-"+month_selected+'-'+date_selected)  # Change this to your desired date
